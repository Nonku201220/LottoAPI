...
$xml_data = file_get_contents("https://www.nationallottery.co.za/xmlfeed/lottoplus.xml");
...
foreach ($xml->record as $record) {
    ...
    $stmt = $conn->prepare("INSERT INTO lottoplus (DrawDate, NextDrawDate, DrawNumber, Ball1, Ball2, Ball3, Ball4, 
